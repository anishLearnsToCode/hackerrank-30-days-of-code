...
This project aims to create a common source from all 30 Days of Code questions on HackerRank and values every single 
contribution made by the community.

We aim to solve all questions in the HackerRank 30 Days of Code tutorial in as many languages as possible to show the 
...
2. Say you solve some problem called __day-0__ on 
    HackerRank using your favorite programming language, say Python then simple add a new file called 
    `day_0.py` in the `python/` directory. 
3. In the [README](README.md) file, add a Python logo along with an file link.
